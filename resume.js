...
function showSearchAndHideResume() {
...
function educationalInfo(education) {
...
function resumeHeaders(name, appliedFor) {
...
function technicalSkillsInfo(keywords) {
...
function provideHobbies(hobbies) {
...
function internshipDetails(internship) {
...
function provideAchievements(achievements) {
...
function checNavButtons(searchResult) {
...
resumeHeaders(searchResult.basics.name, searchResult.basics.AppliedFor)
personalInfo(searchResult.basics)
technicalSkillsInfo(searchResult.skills.keywords)
provideHobbies(searchResult.interests.hobbies)
companyDetails(searchResult.work)
ProjectInfo(searchResult.projects)
educationalInfo(searchResult.education)
internshipDetails(searchResult.Internship)
provideAchievements(searchResult.achievements.Summary)
checNavButtons(searchResult)
}
...
let searchResults = find(searchKeyword);
